...
const en = {
  ...
  "clients.enableQuota": "Limit traffic",
  "clients.enableExpiry": "Set expiry date",
  ...
  "settings.changePasswordHint": "Update the password used to sign in",
  "settings.currentPassword": "Current password",
  "settings.newPassword": "New password",
  "settings.confirmPassword": "Confirm new password",
  "settings.passwordRequired": "Enter current and new password",
...
const ru: Record<keyof typeof en, string> = {
  ...
  "clients.enableQuota": "Ограничить трафик",
  "clients.enableExpiry": "Задать срок действия",
  ...
  "settings.changePasswordHint": "Изменить пароль для входа",
